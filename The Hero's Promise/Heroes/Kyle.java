...
public class Kyle extends Hero {
    ...
    public Kyle(String name) {
        super(name,
              "Steel Strike", "Shield Bash", "Warbringer",
    ...
    public void displayBackStory() {
        ...
        System.out.println();
        System.out.println(
            "Kyle was a loyal captain of the royal guard, " +
            "sworn to protect the kingdom at all costs. " +
            "When the king's corruption led to innocent bloodshed, " +
            "he defected, becoming a wandering warrior seeking " +
            "true justice. Now he fights not for a crown, but for " +
            "the people crushed beneath it."
        );
    }
    ...
    public void displaySkillOptions() {
        System.out.println(
            "Skill 1 (Steel Strike) | " + getSkillOneMultiplier() +
        ...
        System.out.println(
            "Skill 3 (Warbringer) | " + getSkillThreeMultiplier() +
