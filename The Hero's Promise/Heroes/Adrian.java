...
public class Adrian extends Hero {
    ...
    public void displayBackStory() {
        ...
        System.out.println();
        System.out.println("Adrian was born with an innate connection to the arcane, a secret he guarded from a world that feared magic. After his village was razed by anti-magic fanatics, he embraced his power fully, vowing to master every spell to ensure no one ever suffers as his family did.");
    }

    @Override
    public void displaySkillOptions() {
        System.out.println("Skill 1 (Arcane Bolt) | " + getSkillOneMultiplier() + " damage | " + getSkillOneManaCost() + " Mana cost");
        System.out.println("Skill 2 (Mana Barrier) | " + getSkillTwoMultiplier() + " damage | " + getSkillTwoManaCost() + " Mana cost");
        System.out.println("Skill 3 (Fireball) | " + getSkillThreeMultiplier() + " damage | " + getSkillThreeManaCost() + " Mana cost");
